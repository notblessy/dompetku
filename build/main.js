...
/* harmony import */ var google_auth_library__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! google-auth-library */ "google-auth-library");
/* harmony import */ var google_auth_library__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(google_auth_library__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../config */ "./src/config.js");
/* harmony import */ var _models_users__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/users */ "./src/models/users.js");
/* harmony import */ var _utils_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/form */ "./src/utils/form.js");
...
const login = async (req, res) => {
  ...
  const errors = await Object(_utils_form__WEBPACK_IMPORTED_MODULE_5__["validateAll"])(req.body, rules);
  ...
  try {
    const client = new google_auth_library__WEBPACK_IMPORTED_MODULE_2__["OAuth2Client"](_config__WEBPACK_IMPORTED_MODULE_3__["default"].GOOGLE_CLIENT_ID);
    const ticket = await client.verifyIdToken({
      idToken: req.body.id_token,
      audience: _config__WEBPACK_IMPORTED_MODULE_3__["default"].GOOGLE_CLIENT_ID
    });
    const googlePayload = ticket.getPayload();
    const jwtOptions = {
      issuer: 'api.dompetku.id',
      subject: 'access',
      algorithm: _config__WEBPACK_IMPORTED_MODULE_3__["default"].JWT_ALGORITHM
    };
    const data = await _models_users__WEBPACK_IMPORTED_MODULE_4__["default"].query().where('email', googlePayload.email).first();

    if (!data) {
      const newUser = await _models_users__WEBPACK_IMPORTED_MODULE_4__["default"].query().insert({
      ...
      const token = jsonwebtoken__WEBPACK_IMPORTED_MODULE_0___default.a.sign(payload, _config__WEBPACK_IMPORTED_MODULE_3__["default"].JWT_SECRET, jwtOptions);
      return res.json({
        type: 'Bearer',
        token: token,
        data: newUser
...
/*!*******************************!*\
  !*** ./src/database/index.js ***!
  \*******************************/
/*! exports provided: conn, BaseModel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var objection_visibility__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! objection-visibility */ "objection-visibility");
/* harmony import */ var objection_visibility__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(objection_visibility__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../config */ "./src/config.js");




const conn = knex__WEBPACK_IMPORTED_MODULE_0___default()({
  client: 'mysql',
  connection: _config__WEBPACK_IMPORTED_MODULE_3__["default"].MYSQL_CONNECTION
});
class BaseModel extends objection_visibility__WEBPACK_IMPORTED_MODULE_2___default()(objection__WEBPACK_IMPORTED_MODULE_1__["Model"]) {
...
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @sentry/node */ "@sentry/node");
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_sentry_node__WEBPACK_IMPORTED_MODULE_1__);
...
if (_config__WEBPACK_IMPORTED_MODULE_4__["default"].ENV === 'production') {
  app.use(_sentry_node__WEBPACK_IMPORTED_MODULE_1__["Handlers"].errorHandler());
}

app.listen(_config__WEBPACK_IMPORTED_MODULE_4__["default"].PORT, () => console.info(`App listening at http://localhost:${_config__WEBPACK_IMPORTED_MODULE_4__["default"].PORT}. Environment: ${_config__WEBPACK_IMPORTED_MODULE_4__["default"].ENV}`));
...
class User extends _database__WEBPACK_IMPORTED_MODULE_0__["BaseModel"] {}

_defineProperty(User, "tableName", 'users');
...
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./config */ "./src/config.js");
/* harmony import */ var _controllers_auth__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/auth */ "./src/controllers/auth.js");
...
const jwtMiddleware = express_jwt__WEBPACK_IMPORTED_MODULE_1___default()({
  secret: _config__WEBPACK_IMPORTED_MODULE_3__["default"].JWT_SECRET,
  algorithms: [_config__WEBPACK_IMPORTED_MODULE_3__["default"].JWT_ALGORITHM],
...
routes.post('/login', _controllers_auth__WEBPACK_IMPORTED_MODULE_4__["login"]);
...
/* harmony import */ var indicative__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! indicative */ "indicative");
/* harmony import */ var indicative__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(indicative__WEBPACK_IMPORTED_MODULE_0__);

const validateAll = async (data, rules) => {
  return await indicative__WEBPACK_IMPORTED_MODULE_0__["validator"].validateAll(data, rules).then(() => null).catch(err => err);
};
...
module.exports = __webpack_require__(/*! /Users/notblessy/projects/dompetku-backend/src/index.js */"./src/index.js");
...
module.exports = require("indicative");
...
/*!***************************************!*\
  !*** external "objection-visibility" ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("objection-visibility");
